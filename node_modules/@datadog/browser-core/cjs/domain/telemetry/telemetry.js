...
exports.startTelemetryTransport = startTelemetryTransport;
...
const encoder_1 = require("../../tools/encoder");
...
function startTelemetryTransport(configuration, telemetryObservable) {
    ...
    if ((0, transport_1.canUseEventBridge)()) {
        ...
        const telemetryBatch = (0, transport_1.createBatch)({
            encoder: (0, encoder_1.createIdentityEncoder)(),
            request: (0, transport_1.createHttpRequest)(endpoints, 
            // Ignore transport errors for telemetry
            functionUtils_1.noop),
            flushController: (0, transport_1.createFlushController)({
                pageMayExitObservable: (0, pageMayExitObservable_1.createPageMayExitObservable)(configuration),
