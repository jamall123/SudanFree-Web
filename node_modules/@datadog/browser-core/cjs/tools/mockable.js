...
exports.mockableReplacements = void 0;
exports.mockable = mockable;
exports.mockableReplacements = new Map();
/**
...
function mockable(value) {
    ...
    if ("6.28.0" === 'test' && exports.mockableReplacements.has(value)) {
        return exports.mockableReplacements.get(value);
    }
