...
const isActionChildEvent_1 = require("./isActionChildEvent");
function trackClickActions(lifeCycle, domMutationObservable, windowOpenObservable, configuration) {
    const actionTracker = (0, eventTracker_1.startEventTracker)(lifeCycle);
...
function newClick(lifeCycle, actionTracker, getUserActivity, clickActionBase, startEvent) {
    const clickKey = (0, browser_core_1.generateUUID)();
    ...
    function stop(activityEndTime) {
        ...
        actionTrackerFinishedEvent = activityEndTime
            ? actionTracker.stop(clickKey, (0, browser_core_1.timeStampToClocks)(activityEndTime))
