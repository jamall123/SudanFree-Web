...
exports.EVENT_CONTEXT_TIME_OUT_DELAY = void 0;
exports.startEventTracker = startEventTracker;
const browser_core_1 = require("@datadog/browser-core");
const trackEventCounts_1 = require("./trackEventCounts");
exports.EVENT_CONTEXT_TIME_OUT_DELAY = 5 * browser_core_1.ONE_MINUTE; // arbitrary
function startEventTracker(lifeCycle) {
    // Used by actions to associate events with actions.
    const history = (0, browser_core_1.createValueHistory)({ expireDelay: exports.EVENT_CONTEXT_TIME_OUT_DELAY });
    ...
    function cleanUpEvent(event) {
        ...
        (_a = event.eventCounts) === null || _a === void 0 ? void 0 : _a.stop();
    }
    function discardAll() {
    ...
    const sessionRenewalSubscription = lifeCycle.subscribe(10 /* LifeCycleEventType.SESSION_RENEWED */, discardAll);
    function start(key, startClocks, data, options) {
        ...
        const eventCounts = (options === null || options === void 0 ? void 0 : options.isChildEvent)
            ? (0, trackEventCounts_1.trackEventCounts)({
                lifeCycle,
    ...
    function stop(key, stopClocks, extraData) {
        ...
        const finalData = extraData ? (0, browser_core_1.combine)(event.data, extraData) : event.data;
        event.historyEntry.close(stopClocks.relative);
        const duration = (0, browser_core_1.elapsed)(event.startClocks.relative, stopClocks.relative);
