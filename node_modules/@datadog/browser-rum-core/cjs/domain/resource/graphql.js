...
exports.extractGraphQlRequestMetadata = extractGraphQlRequestMetadata;
...
function parseGraphQlResponse(responseText) {
    ...
    if (!(0, browser_core_1.isNonEmptyArray)(responseObj.errors)) {
        return;
    }
...
function extractFromUrlQueryParams(url) {
    const searchParams = (0, browser_core_1.buildUrl)(url).searchParams;
...
function sanitizeGraphQlMetadata(rawMetadata, trackPayload) {
    ...
    if (rawMetadata.query) {
        ...
        if (trackPayload) {
            payload = (0, browser_core_1.safeTruncate)(trimmedQuery, GRAPHQL_PAYLOAD_LIMIT, '...');
        }
    }
